#!/usr/bin/env bash
# Apply the adversarial-review repository protections via the GitHub REST API:
...
#   - REPO            target repo (default voodootikigod/adversarial-review)
...
REPO="${REPO:-voodootikigod/adversarial-review}"
